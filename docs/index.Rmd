...
knitr::opts_chunk$set(echo = FALSE, cache = FALSE, message=FALSE, warning = FALSE, 
                      fig.path = "images/", fig.height = 2.5, fig.width = 6, 
                      out.width = "100%")
...
<img src="https://miro.medium.com/max/739/1*mF9Pv4NNnzZhT1ocEPOgvQ.png" class="fullpage">
...
## Função de perda ou de custo { .fullpage }

<img src="https://i.stack.imgur.com/DmKq7.png" class="fullpage">
...
## Problemas de convergência { .fullpage}
 
<img src="https://miro.medium.com/max/1050/1*JTC4ReFwSeAt3kvTLq1YoA.png" class="fullpage">
 
## Outras funções de perda { .fullpage}

<img src="https://miro.medium.com/max/720/1*BploIBOUrhbgdoB1BK_sOg.png" class="fullpage width">
...
<img src="https://miro.medium.com/max/856/1*h_iOn3gSUa2bk6o0foudDA.png" class="fullpage">
