...
Ou seja, assumindo que a distribuição dos dados é simétrica, onde média e mediana
coincidem, são necessário aproximadamente 36% menos dados para a regressão à média
obter a mesma precisão que a regressão à mediana.
