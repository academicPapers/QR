...
é o gráfico de Galton, por nós reproduzido na figura \ref{fig:galton}.

O gráfico ilustra o fenômeno, descoberto por Galton, da regressão à média. 

![Regressão à média (Galton, 1885)](refs/image-002.png)
...
Posteriormente, com a chegada do *méthode de moindre carré*, ou seja, do método 
...
achados na época. Ver a este respeito @STIGLER197731.
...
largos do que os intervalos de confiança para a regressão linear [@koenker2000, 354].
