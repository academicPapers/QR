...
estimar se a hipótese elipsoidal, prevista na obra-prima de @newton, estaria 
correta, em função de cinco observações do comprimento de um grau de latitude
obtidas em diferentes longitudes [@koenker2000, p. 353; @tortoise, p. 281; @stigler1986, p. 40]:
...
depois, @laplace1789 resolveu o problema matematicamente em 1789 [@tortoise, 281],
no que pode ser considerada a primeira análise de regressão. 
...
Boscovich/Laplace ficou em segundo plano. Até que @edgeworth, relaxando a 
restrição de que a soma dos resíduos seja igual a zero ($\sum \hat u_i = 0$)  [@tortoise, 281], 
